package com.mbr_claim.entities;
...
public class MBR {
	...
	public String toString() {
		return "MBR [mbr_id=" + mbr_id + ", rec_src_cd=" + rec_src_cd + ", valid_from_dtm=" + valid_from_dtm
				+ ", valid_thru_dtm=" + valid_thru_dtm + ", curr_indc=" + curr_indc + "]";
	}
